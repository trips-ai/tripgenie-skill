---
name: tripgenie
description: Your go-to AI travel assistant from Trip.com. Instantly book hotels, flights, and trains. Discover attractions, get travel tips, and plan your perfect trip with a single query.
...
Provide detailed natural language descriptions in your `query` for the best results.

### Hotel Search

Supports complex searches by location, brand, rating, price, amenities, and room type.

**Examples**:
- **Basic search**: `"Book a hotel in London"`
- **With price and rating**: `"Find a 5-star hotel near Times Square, New York under $400 with a city view"`
- **Specific room type**: `"Find a family-friendly hotel near Disneyland Shanghai with twin beds or a family room"`
- **Specific amenities**: `"Recommend a hotel in Bangkok with a swimming pool and a gym"`

### Flight Search

Supports one-way, round-trip, multi-city, international/domestic, and low-fare searches.

**Examples**:
- **One-way search**: `"A one-way flight from Shanghai to Beijing tomorrow"`
- **Round-trip search**: `"Find a round-trip flight from San Francisco to Honolulu for next weekend"`
- **Low-fare search**: `"Where is the cheapest place to fly to from Singapore next month?"`
- **International flight**: `"Search for a direct international flight from New York to Paris next week"`
- **With class**: `"Book a business class ticket on Emirates from Dubai to London"`

### Train Ticket Search

Supports searches by train type (high-speed), seat class, and time.

**Examples**:
- **Basic search**: `"I need a high-speed train ticket from Beijing to Shanghai for tomorrow"`
- **With seat class**: `"Are there any second-class seats left for this Friday's train from London to Paris?"`

### Attractions & Recommendations

Supports recommendations, information, and ticket price inquiries for attractions.

**Examples**:
- **Recommendations**: `"What are some must-see attractions in Rome?"`
- **Ticket inquiry**: `"What are the ticket prices and opening hours for the Louvre Museum in Paris?"`
- **Themed recommendations**: `"I want to take my kids to a theme park. What do you recommend in Orlando?"`
